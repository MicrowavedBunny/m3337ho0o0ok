...
//
	...
	{
		_RTL_BALANCED_NODE* lr[2];
		size_t parent_and_color;
	};
	...
	char RtlRbRemoveNode(_RTL_RB_TREE* Tree, _RTL_BALANCED_NODE* Node);
	void RtlRbInsertNodeEx(_RTL_RB_TREE* Tree, _RTL_BALANCED_NODE* Parent, BOOLEAN Right, _RTL_BALANCED_NODE* Node);
